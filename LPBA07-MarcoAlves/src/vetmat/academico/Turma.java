...
public class Turma {
    ...
    public void calcularMedia(){
        for (int aluno=0; aluno<(nomes.length-1); aluno++) {
    ...
    public void mostrarNotas() {
        ...
        //Repetição para listar dados: Sequencia
        //Checar se nome existe, se existir escreva e mostre as notas
        //se nome não existir, não fazer nada a.k.a Pare
