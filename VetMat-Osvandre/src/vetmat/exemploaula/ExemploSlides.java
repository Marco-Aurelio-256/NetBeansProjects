...
public class ExemploSlides {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s   %.01f     %.01f    %.01f     %.01f     %.01f %n", "Zezinho ",9.5F,8F,7F,9F,9F);
        System.out.printf("%s   %.01f     %.01f    %.01f     %.01f     %.01f %n", "Huguinho",10F,8F,7F,9F,9F);
        System.out.printf("%s   %.01f     %.01f    %.01f     %.01f     %.01f %n", "Luizinho",10F,8F,7F,9F,9F);
